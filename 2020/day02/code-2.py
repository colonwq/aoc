...
def test_password(first_char, second_char, req_char, password):
    #print("min: %d max: %d req:%s password: %s" %(first_char, second_char, req_char, password) )
    found = 0
    if password[first_char] == req_char and password[second_char] == req_char:
